...
@section('content')
<div class="page-header electrical">
	<h1>Electrical</h1>
</div>
		...
		<div class="col-set">
			<div class="col-1">
				...
				<ul class="arrow blue columns">
					...
					<li>Lighting-low voltage</li>
					<li>Power shower installations</li>
					<li>Rewiring</li>
